    ...
    <section id="home" className="relative min-h-screen flex items-end md:items-center pb-8 md:pb-0">
      ...
      <div className="relative section-container px-5 md:px-8 pt-16 md:pt-20">
        <div className="max-w-2xl">
          ...
          <h1 className="text-[28px] sm:text-[34px] md:text-[44px] lg:text-[54px] font-heading font-bold uppercase leading-tight tracking-tight text-white mb-2 md:mb-3 whitespace-pre-line">
            {t("hero.title")}
          </h1>

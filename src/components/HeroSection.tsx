...
import rioryVanHero from "@/assets/riory-van-hero-two.webp";
    ...
    <section id="home" className="bg-charcoal pt-16 md:pt-20">
      <div className="grid lg:grid-cols-[0.62fr_1.38fr]">
        <div className="relative min-h-[280px] sm:min-h-[360px] lg:min-h-[680px] bg-muted overflow-hidden order-1 lg:order-2">
          <img
            src={rioryVanHero}
            alt="Riory servicewagens — ontstoppingsdienst en rioleringswerken"
        ...
        <div className="order-2 lg:order-1 bg-charcoal text-white px-6 py-9 sm:px-8 sm:py-11 md:px-12 lg:px-14 lg:py-14 xl:px-20 flex items-center">
          <div className="max-w-xl">
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-7">
              ...
              <a
                ...
                className="inline-flex h-12 md:h-14 items-center justify-center gap-2 whitespace-nowrap rounded-xl border border-white/25 bg-white/5 px-5 md:px-8 font-heading font-bold text-xs sm:text-sm md:text-base uppercase tracking-wide text-white hover:bg-white hover:text-foreground transition-colors"
              >
            ...
            <div className="flex flex-nowrap gap-1.5 sm:gap-2.5 border-t border-white/10 pt-5 overflow-x-auto [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">

    ...
    <div className="fixed bottom-0 left-0 right-0 z-50 p-4 md:p-6 animate-in slide-in-from-bottom duration-500">
      <div className="max-w-lg mx-auto bg-card border border-border rounded-2xl shadow-lg p-5 md:p-6">
        <div className="flex items-start gap-3 mb-4">
          ...
          <div>
            <h3 className="font-heading font-semibold text-foreground text-sm mb-1">{t("cookieBanner.title")}</h3>
            <p className="text-xs text-muted-foreground font-body leading-relaxed">
              {t("cookieBanner.text")}{" "}
              <Link to={localizedPath("/cookie-policy")} className="underline hover:text-primary transition-colors">

...
export const allLocations: LocationData[] = [
  ...
  },
  {
    ...
    services: [
      ...
      { title: "Camera-inspectie riool in Riemst", description: "Brengt scheuren, verzakkingen en wortelingroei in kaart zonder breekwerk — ideaal bij de oudere hoeves rond Herderen en Genoelselderen.", slug: "camera-inspectie" },
      { title: "Septische put ledigen in Riemst", description: "Riory ledigt en reinigt septische putten en beerputten — veel voorkomend in het landelijke buitengebied richting Membruggen en Val-Meer.", slug: "septische-put-ledigen" },
    ],
    faq: [
      { question: "Hoe snel komt Riory ter plaatse in Riemst?", answer: "Riemst grenst rechtstreeks aan Bilzen, waar Riory gevestigd is — daardoor staan we vaak sneller ter plaatse dan ontstoppingsdiensten die van verder moeten komen. Bij spoedgevallen rekent u doorgaans op 1 à 2 uur, 24/7." },
